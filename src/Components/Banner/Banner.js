    ...
    return (
        ...
        >
            <div className="banner__contents">
                ...
                <h1 className="banner__description">{truncate(`trhrtgjdrtgjtdrg`, 150)}</h1>
            </div>
